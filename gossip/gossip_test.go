...
import (
	...
	"github.com/chainpoint/tendermint/abci/example/counter"
	"github.com/chainpoint/tendermint/abci/example/kvstore"
	abciserver "github.com/chainpoint/tendermint/abci/server"
...
func newMempoolWithApp(cc proxy.ClientCreator) (*Gossip, cleanupFunc) {
	return newMempoolWithAppAndConfig(cc, cfg.ResetTestRoot("mempool_test"))
}

func newMempoolWithAppAndConfig(cc proxy.ClientCreator, config *cfg.Config) (*Gossip, cleanupFunc) {
...
func checkTxs(t *testing.T, mempool *Gossip, count int, peerID uint16) types.Txs {
...
// https://github.com/chainpoint/tendermint/issues/3509
