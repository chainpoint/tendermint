...
// Examples
//
// - [Tendermint](https://github.com/chainpoint/tendermint/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/chainpoint/tendermint/blob/master/tools/tm-monitor/rpc.go)
package rpc
