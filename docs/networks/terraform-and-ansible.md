...
script](https://github.com/chainpoint/tendermint/blob/master/networks/remote/integration.sh)
...
```
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/chainpoint/tendermint/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/chainpoint/tendermint/networks/remote/ansible/mytestnet
```
