...
To use your own abci applications with 4-node setup edit the [docker-compose.yaml](https://github.com/chainpoint/tendermint/blob/master/docker-compose.yml) file and add image to your abci application.
