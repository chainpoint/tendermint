...
To use your own abci applications with 4-node setup edit the [docker-compose.yaml](https://github.com/chainpoint/tendermint/blob/develop/docker-compose.yml) file and add image to your abci application.
...
Override the [command](https://github.com/chainpoint/tendermint/blob/master/networks/local/localnode/Dockerfile#L12) in each node to connect to it's abci. 
...
Similarly do for node1, node2 and node3 then [run testnet](https://github.com/chainpoint/tendermint/blob/master/docs/networks/docker-compose.md#run-a-testnet)
