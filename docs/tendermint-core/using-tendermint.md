...
definition](https://github.com/chainpoint/tendermint/blob/master/types/genesis.go)).
...
See the
[UPGRADING.md](https://github.com/chainpoint/tendermint/blob/master/UPGRADING.md)
