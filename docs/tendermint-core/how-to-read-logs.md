...
- `abci-client` As mentioned in [Application Development Guide](../app-dev/app-development.md), Tendermint acts as an ABCI
  ...
  be found [here](https://github.com/chainpoint/tendermint/tree/develop/abci/client).
...
- `events` Simple event notification system. The list of events can be
  found
  [here](https://github.com/chainpoint/tendermint/blob/master/types/events.go).
...
- `p2p` Provides an abstraction around peer-to-peer communication. For
  ...
  [README](https://github.com/chainpoint/tendermint/blob/master/p2p/README.md).
- `rpc` [Tendermint's RPC](./rpc.md).
- `rpc-server` RPC server. For implementation details, please read the
  [doc.go](https://github.com/chainpoint/tendermint/blob/master/rpc/lib/doc.go).
