...
[Blockchain](https://github.com/chainpoint/tendermint/blob/master/docs/spec/blockchain/blockchain.md#blockid) section) that uniquely identifies each block. The block itself is
...
current round). Vote is defined in the [Blockchain](https://github.com/chainpoint/tendermint/blob/master/docs/spec/blockchain/blockchain.md#blockid) section and contains validator's
