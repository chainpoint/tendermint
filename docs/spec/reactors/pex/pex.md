...
See the [trustmetric](https://github.com/chainpoint/tendermint/blob/master/docs/architecture/adr-006-trust-metric.md)
and [trustmetric useage](https://github.com/chainpoint/tendermint/blob/master/docs/architecture/adr-007-trust-metric-usage.md)
