...
- To _prevote_ or _precommit_ something means to broadcast a [prevote
  vote](https://godoc.org/github.com/chainpoint/tendermint/types#Vote)
  or [first precommit
  vote](https://godoc.org/github.com/chainpoint/tendermint/types#FirstPrecommit)
  for something.
...
- Nodes gossip to nodes lagging in blockchain height with block
  [commits](https://godoc.org/github.com/chainpoint/tendermint/types#Commit)
  for older blocks.
...
voting power (see
[implementation](https://github.com/chainpoint/tendermint/blob/develop/types/validator_set.go)).
