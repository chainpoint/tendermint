...
application](https://github.com/chainpoint/tendermint/blob/master/abci/example/kvstore/kvstore.go),
which is a part of the abci repo. [persistent_kvstore
application](https://github.com/chainpoint/tendermint/blob/master/abci/example/kvstore/persistent_kvstore.go)
