...
application](https://github.com/chainpoint/tendermint/blob/develop/abci/example/kvstore/kvstore.go),
which is a part of the abci repo. [persistent_kvstore
application](https://github.com/chainpoint/tendermint/blob/develop/abci/example/kvstore/persistent_kvstore.go)
...
docs](https://godoc.org/github.com/chainpoint/tendermint/lite#hdr-How_We_Track_Validators)
