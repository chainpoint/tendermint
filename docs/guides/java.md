...
file](https://github.com/chainpoint/tendermint/blob/master/abci/types/types.proto).
...
```sh
mkdir -p \
  $KVSTORE_HOME/src/main/proto/github.com/chainpoint/tendermint/abci/types \
  $KVSTORE_HOME/src/main/proto/github.com/chainpoint/tendermint/crypto/merkle \
  $KVSTORE_HOME/src/main/proto/github.com/chainpoint/tendermint/libs/common \
  $KVSTORE_HOME/src/main/proto/github.com/gogo/protobuf/gogoproto

cp $GOPATH/src/github.com/chainpoint/tendermint/abci/types/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/chainpoint/tendermint/abci/types/types.proto
cp $GOPATH/src/github.com/chainpoint/tendermint/crypto/merkle/merkle.proto \
   $KVSTORE_HOME/src/main/proto/github.com/chainpoint/tendermint/crypto/merkle/merkle.proto
cp $GOPATH/src/github.com/chainpoint/tendermint/libs/common/types.proto \
   $KVSTORE_HOME/src/main/proto/github.com/chainpoint/tendermint/libs/common/types.proto
...
package](https://godoc.org/github.com/chainpoint/tendermint/lite)) can leverage
...
Github](https://github.com/chainpoint/tendermint/issues/new/choose). To dig
