...
[lite](https://github.com/chainpoint/tendermint/tree/master/lite) package. This
...
rules](https://github.com/chainpoint/tendermint/blob/master/docs/spec/blockchain/blockchain.md#validation)
to each block.
...
[here](https://github.com/chainpoint/tendermint/blob/master/docs/spec/consensus/light-client.md).
