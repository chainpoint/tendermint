...
1. Issue [#2067](https://github.com/chainpoint/tendermint/issues/2067): P2P Refactor
2. PR: [#3506](https://github.com/chainpoint/tendermint/pull/3506): ADR 036: Blockchain Reactor Refactor
