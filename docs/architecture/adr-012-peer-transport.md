...
`[config.P2PConfig`](https://github.com/chainpoint/tendermint/blob/05a76fb517f50da27b4bfcdc7b4cf185fc61eff6/config/config.go#L272-L339).

Addresses:

- [#2046](https://github.com/chainpoint/tendermint/issues/2046)
- [#2047](https://github.com/chainpoint/tendermint/issues/2047)

First iteraton in [#2067](https://github.com/chainpoint/tendermint/issues/2067)
