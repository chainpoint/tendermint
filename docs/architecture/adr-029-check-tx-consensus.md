...
[#2384](https://github.com/chainpoint/tendermint/issues/2384) and reason for rejection
...
Performance impact is considered too great. See [#2384](https://github.com/chainpoint/tendermint/issues/2384)
