...
The original tracking issue for this is [#1648](https://github.com/chainpoint/tendermint/issues/1648).
...
future](https://github.com/chainpoint/tendermint/issues/2840).

Other concerns here include:

- Validator Address [#3596](https://github.com/chainpoint/tendermint/issues/3596) -
    Should the CommitSig include the validator address? It is very convenient to
    do so, but likely not necessary. This was also discussed in [#2226](https://github.com/chainpoint/tendermint/issues/2226).
- Absent Votes [#3591](https://github.com/chainpoint/tendermint/issues/3591) -
...
- Other BlockIDs [#3485](https://github.com/chainpoint/tendermint/issues/3485) -
...
BFT time [can be
mitigated](https://github.com/chainpoint/tendermint/issues/2840#issuecomment-529122431).
...
[#3485](https://github.com/chainpoint/tendermint/issues/3485)
