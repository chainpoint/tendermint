...
[#3639](https://github.com/chainpoint/tendermint/issues/3639) where chunking
...
[#828](https://github.com/chainpoint/tendermint/issues/828).
...
[#3594](https://github.com/chainpoint/tendermint/pull/3594)
based on their initial implementation in
[PR #3243](https://github.com/chainpoint/tendermint/pull/3243)
...
State sync](https://github.com/chainpoint/tendermint/pull/3243), The
...
Sync](http://github.com/chainpoint/tendermint/pull/3594).
...
subjectivity](https://github.com/chainpoint/tendermint/pull/3795)) and
...
## Implementation Path
* Create StateSync reactor based on  [#3753](https://github.com/chainpoint/tendermint/pull/3753)
...
## References
[sync: Sync current state without full replay for Applications](https://github.com/chainpoint/tendermint/issues/828) - original issue
...
[proposal 2 implementation](https://github.com/chainpoint/tendermint/pull/3243)  - ackratos implementation
[WIP General/Lazy State-Sync pseudo-spec](https://github.com/chainpoint/tendermint/issues/3639) - Jae Proposal
[Warp Sync Implementation](https://github.com/chainpoint/tendermint/pull/3594) - ackratos
[Chunk Proposal](https://github.com/chainpoint/tendermint/pull/3799) - Bucky proposed
