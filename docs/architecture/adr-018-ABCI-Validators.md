...
As noted in ADR-009[https://github.com/chainpoint/tendermint/blob/develop/docs/architecture/adr-009-ABCI-design.md],
...
- [Latest ABCI Spec](https://github.com/chainpoint/tendermint/blob/v0.22.8/docs/app-dev/abci-spec.md)
- [ADR-009](https://github.com/chainpoint/tendermint/blob/v0.22.8/docs/architecture/adr-009-ABCI-design.md)
- [Issue #1712 - Don't send PubKey in
  RequestBeginBlock](https://github.com/chainpoint/tendermint/issues/1712)
