...
This ADR assumes that [replacing crypto.Signature with []bytes](https://github.com/chainpoint/tendermint/issues/1957) has been accepted.
...
Evidence for this is outlined in [this issue](https://github.com/chainpoint/tendermint/issues/2077).
