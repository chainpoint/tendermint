...
To contribute to the documentation, see [this file](https://github.com/chainpoint/tendermint/blob/master/docs/DOCS_README.md) for details of the build process and
