...
REPO=github.com/chainpoint/tendermint
go get $REPO
cd $GOPATH/src/$REPO
...
old_ansible_file=$GOPATH/src/github.com/chainpoint/tendermint/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
