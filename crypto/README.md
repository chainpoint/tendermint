...
`import "github.com/chainpoint/tendermint/crypto"`

For any specific algorithm, use its specific module e.g.
`import "github.com/chainpoint/tendermint/crypto/ed25519"`

If you want to decode bytes into one of the types, but don't care about the specific algorithm, use
`import "github.com/chainpoint/tendermint/crypto/amino"`

## Binary encoding

For Binary encoding, please refer to the [Tendermint encoding specification](https://github.com/chainpoint/tendermint/blob/master/docs/spec/blockchain/encoding.md).
