...
import (
	...
	"github.com/chainpoint/tendermint/libs/db"
	protodb "github.com/chainpoint/tendermint/libs/db/remotedb/proto"
)
...
//  * memdB
//  * leveldb
// See https://godoc.org/github.com/chainpoint/tendermint/libs/db#DBBackendType
