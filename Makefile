...
rpc-docs:
	...
	godoc2md -template rpc/core/doc_template.txt github.com/chainpoint/tendermint/rpc/core | grep -v -e "pipe.go" -e "routes.go" -e "dev.go" | sed 's,/src/target,https://github.com/chainpoint/tendermint/tree/master/rpc/core,' >> $(DESTINATION)
