...
import (
	...
	log "github.com/chainpoint/tendermint/libs/log"
	lerr "github.com/chainpoint/tendermint/lite/errors"
...
// see https://github.com/chainpoint/tendermint/issues/3170
...
func (dv *DynamicVerifier) Verify(shdr types.SignedHeader) error {
	...
	// See https://github.com/chainpoint/tendermint/issues/3174.
